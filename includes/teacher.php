...
<div class="row" id="gridView" style="display: none;">
    ...
    <div class="card shadow border-0 h-100">
      ...
      <div class="card-body text-left">
        ...
        <table class="table table-sm table-borderless text-start mb-0 mt-3">
          ...
          <tr>
            <th class="text-muted">Login Pass:</th>
            <td><?= htmlspecialchars($row['login_pass']) ?></td>
          </tr>
          <tr>
  ...
  <!-- Updare Read Teacher Modal -->
 <div class="modal fade" id="UpdateTeacherModal" tabindex="-1">
  <div class="modal-dialog" id="UpdateTeacherBody">
 ...
 <div class="modal fade" id="addTeacherModal" tabindex="-1">
  <div class="modal-dialog">
    <form method="POST" enctype="multipart/form-data" class="modal-content" id="TeacherForm"> <!-- ✅ Only One FORM -->
